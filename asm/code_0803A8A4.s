...
func_0803B2A8: @ 0x0803B2A8
	...
	ldrb r2, [r0]
	lsls r1, r2, #4
	ldr r0, _0803B2D8 @ =gUnk_080F1948
	adds r1, r1, r0
	mov sl, r1
	movs r7, #0
	movs r0, #0
...
func_0803B840: @ 0x0803B840
	...
	lsls r1, r1, #0xd
	lsrs r1, r1, #0x1c
	ldr r0, _0803B8C8 @ =gUnk_080F9F78
	ldr r0, [r0]
	lsls r1, r1, #5
	movs r2, #0xa0
	lsls r2, r2, #0x13
...
func_0803B8CC: @ 0x0803B8CC
	...
	lsls r3, r3, #9
	adds r2, r3, r7
	ldr r0, _0803BA94 @ =gUnk_080F9F74
	ldr r0, [r0]
	lsrs r5, r0, #5
	movs r4, #0
	ldr r0, [sp, #0x3c]
...
_0803B9C4:
	mov r1, ip
	adds r1, #0x2c
	ldr r0, _0803BA98 @ =gUnk_080F9F70
	ldr r3, [r0]
	lsls r2, r2, #5
	movs r0, #0xc0
	lsls r0, r0, #0x13
...
_0803BA94: .4byte gUnk_080F9F74
_0803BA98: .4byte gUnk_080F9F70
...
_0803C0A6:
	...
	bl func_08008B6C
_0803C0B2:
	ldr r0, _0803C0C4 @ =gUnk_080F1A34
	ldrb r1, [r7, #0xc]
	lsls r1, r1, #2
	adds r1, r1, r0
	ldr r1, [r1]
...
_0803C116:
	...
	adds r0, r3, #0
	bl _call_via_r2
	ldr r1, _0803C4D4 @ =gUnk_080F1A34
	ldrb r0, [r7, #0xc]
	lsls r0, r0, #2
	adds r0, r0, r1
	ldr r0, [r0]
...
func_0803C5B0: @ 0x0803C5B0
	...
	bl __builtin_new
	adds r7, r0, #0
	ldr r1, _0803C78C @ =gUnk_0875B444
	bl func_0805E6CC
	adds r0, r7, #0
	adds r0, #0x30
	ldr r1, _0803C790 @ =gUnk_086678A0
	bl func_0805E6CC
	adds r4, r7, #0
	adds r4, #0x60
	adds r0, r4, #0
	...
	adds r0, r7, r1
	strb r6, [r0]
	ldr r1, _0803C79C @ =gUnk_0875A440
	movs r2, #0xe8
	lsls r2, r2, #2
	adds r1, r1, r2
	movs r2, #0x92
	...
	bx r1
	.align 2, 0
_0803C78C: .4byte gUnk_0875B444
_0803C790: .4byte gUnk_086678A0
_0803C794: .4byte vtable_unk_080E77D0
_0803C798: .4byte 0x000002F1
_0803C79C: .4byte gUnk_0875A440
...
_0803CD8E:
	...
	adds r0, #0x84
	lsls r1, r5, #5
	ldr r2, _0803CE30 @ =gUnk_0875A440
	mov sl, r2
	add r1, sl
	movs r2, #0x20
	bl memcpy
...
_0803CE50:
	lsls r1, r5, #5
	ldr r0, _0803CE74 @ =gUnk_0875A440
	adds r1, r1, r0
	adds r0, r7, #0
	adds r0, #0xe4
	movs r2, #0x20
...
_0803CEEA:
	...
	ldr r1, [sp]
	lsls r1, r1, #5
	ldr r2, _0803CF90 @ =gUnk_0875A440
	mov r8, r2
	add r1, r8
	movs r2, #0x20
	bl memcpy
...
_0803CF6A:
	...
	ble _0803CF94
	lsls r1, r5, #5
	ldr r0, _0803CF90 @ =gUnk_0875A440
	adds r1, r1, r0
	movs r2, #0xa2
	lsls r2, r2, #1
	adds r0, r7, r2
...
_0803CFA6:
	...
	strb r0, [r1]
	lsls r1, r4, #5
	ldr r2, _0803D050 @ =gUnk_0875A440
	mov sl, r2
	add r1, sl
	movs r2, #0xb2
	lsls r2, r2, #1
...
_0803D0B4:
	...
	ldr r2, [sp]
	lsls r1, r2, #5
	ldr r5, _0803D0EC @ =gUnk_0875A440
	adds r1, r1, r5
	movs r2, #0x20
	bl memcpy
	movs r0, #0xc6
...
func_0803D0F0: @ 0x0803D0F0
	...
	ble _0803D130
	lsls r1, r5, #5
	ldr r0, _0803D12C @ =gUnk_0875A440
	adds r1, r1, r0
	adds r0, r7, #0
	adds r0, #0xc4
	movs r2, #0x20
...
_0803D14C:
	...
	strb r0, [r1]
	lsls r1, r4, #5
	ldr r0, _0803D178 @ =gUnk_0875A440
	adds r1, r1, r0
	adds r0, r7, #0
	adds r0, #0xe4
	movs r2, #0x20
...
_0803D1EE:
	...
	ldr r1, [sp]
	lsls r1, r1, #5
	ldr r5, _0803D23C @ =gUnk_0875A440
	adds r1, r1, r5
	movs r2, #0x20
	bl memcpy
	movs r2, #0xac
...
_0803D250:
	lsls r1, r1, #5
	ldr r0, _0803D2A4 @ =gUnk_0875A440
	adds r1, r1, r0
	movs r2, #0x82
	lsls r2, r2, #1
	adds r0, r6, r2
...
_0803D2BA:
	...
	strb r0, [r7]
	lsls r1, r4, #5
	ldr r0, _0803D2E4 @ =gUnk_0875A440
	adds r1, r1, r0
	movs r2, #0xb2
	lsls r2, r2, #1
	adds r0, r6, r2
...
func_0803D2E8: @ 0x0803D2E8
	...
	cmp r1, #0
	beq _0803D314
	ldr r1, _0803D310 @ =gUnk_0875A440
	movs r0, #0xa0
	lsls r0, r0, #1
	adds r1, r1, r0
	movs r2, #0x8a
...
func_0803D340: @ 0x0803D340
	...
	adds r5, r0, #0
	lsls r4, r4, #5
	ldr r0, _0803D39C @ =gUnk_0875A440
	mov r8, r0
	add r4, r8
	movs r1, #0x92
	lsls r1, r1, #2
...
func_0803D644: @ 0x0803D644
	...
	adds r2, r2, r1
	str r2, [sp, #4]
	ldr r0, _0803D684 @ =gUnk_080F1A66
	adds r4, r0, #0
	adds r4, #0xe
	movs r1, #0
	str r1, [sp]
...
func_0803D7E4: @ 0x0803D7E4
	...
	adds r5, r1, #0
	adds r0, #0x70
	ldr r1, _0803D9A4 @ =gUnk_080F280C
	adds r2, r5, #0
	bl func_0803D688
	adds r0, r4, #0
	adds r0, #0x84
	ldr r1, _0803D9A8 @ =gUnk_080F1A80
	adds r2, r5, #0
	bl func_0803D688
	adds r0, r4, #0
	adds r0, #0x98
	ldr r1, _0803D9AC @ =gUnk_080F1FC0
	adds r2, r5, #0
	bl func_0803D688
	adds r0, r4, #0
	adds r0, #0xb0
	ldr r1, _0803D9B0 @ =gUnk_080F8678
	adds r2, r5, #0
	bl func_0803D688
	adds r0, r4, #0
	adds r0, #0xc4
	ldr r1, _0803D9B4 @ =gUnk_080F81BC
	adds r2, r5, #0
	bl func_0803D688
	adds r0, r4, #0
	adds r0, #0xd8
	ldr r1, _0803D9B8 @ =gUnk_080F77FC
	adds r2, r5, #0
	bl func_0803D688
	adds r0, r4, #0
	adds r0, #0xf0
	ldr r1, _0803D9BC @ =gUnk_080F7294
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0x82
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9C0 @ =gUnk_080F6370
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0x8c
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9C4 @ =gUnk_080F66C4
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0x96
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9C8 @ =gUnk_080F49C0
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xa0
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9CC @ =gUnk_080F5540
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xaa
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9D0 @ =gUnk_080F4D74
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xb6
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9D4 @ =gUnk_080F59CC
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xc0
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9D8 @ =gUnk_080F6B4C
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xca
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9DC @ =gUnk_080F33B8
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xd4
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9E0 @ =gUnk_080F61FC
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xde
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9E4 @ =gUnk_080F3408
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xe8
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9E8 @ =gUnk_080F3FD8
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xf2
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9EC @ =gUnk_080F35E4
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xfe
	lsls r1, r1, #1
	adds r0, r4, r1
	ldr r1, _0803D9F0 @ =gUnk_080F3010
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0x84
	lsls r1, r1, #2
	adds r0, r4, r1
	ldr r1, _0803D9F4 @ =gUnk_080F5D94
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0x8a
	lsls r1, r1, #2
	adds r0, r4, r1
	ldr r1, _0803D9F8 @ =gUnk_080F6DE8
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0x8f
	lsls r1, r1, #2
	adds r0, r4, r1
	ldr r1, _0803D9FC @ =gUnk_080F2AF8
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0x94
	lsls r1, r1, #2
	adds r0, r4, r1
	ldr r1, _0803DA00 @ =gUnk_080F42F0
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0x99
	lsls r1, r1, #2
	adds r0, r4, r1
	ldr r1, _0803DA04 @ =gUnk_080F43DC
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0x9f
	lsls r1, r1, #2
	adds r0, r4, r1
	ldr r1, _0803DA08 @ =gUnk_080F6FF8
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xa4
	lsls r1, r1, #2
	adds r0, r4, r1
	ldr r1, _0803DA0C @ =gUnk_080F7B40
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xaa
	lsls r1, r1, #2
	adds r0, r4, r1
	ldr r1, _0803DA10 @ =gUnk_080F2DC0
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xaf
	lsls r1, r1, #2
	adds r0, r4, r1
	ldr r1, _0803DA14 @ =gUnk_080F597C
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xc4
	lsls r1, r1, #2
	adds r0, r4, r1
	ldr r1, _0803DA18 @ =gUnk_080F6B10
	adds r2, r5, #0
	bl func_0803D688
	movs r1, #0xca
	lsls r1, r1, #2
	adds r0, r4, r1
	ldr r1, _0803DA1C @ =gUnk_080F4974
	adds r2, r5, #0
	bl func_0803D688
	adds r0, r4, #0
	bl func_080A0A04
	cmp r0, #0
	beq _0803D99E
	ldr r1, _0803DA20 @ =gUnk_080F29C0
	adds r2, r5, #0
	bl func_0803D688
_0803D99E:
	pop {r4, r5}
	...
	bx r0
	.align 2, 0
_0803D9A4: .4byte gUnk_080F280C
_0803D9A8: .4byte gUnk_080F1A80
_0803D9AC: .4byte gUnk_080F1FC0
_0803D9B0: .4byte gUnk_080F8678
_0803D9B4: .4byte gUnk_080F81BC
_0803D9B8: .4byte gUnk_080F77FC
_0803D9BC: .4byte gUnk_080F7294
_0803D9C0: .4byte gUnk_080F6370
_0803D9C4: .4byte gUnk_080F66C4
_0803D9C8: .4byte gUnk_080F49C0
_0803D9CC: .4byte gUnk_080F5540
_0803D9D0: .4byte gUnk_080F4D74
_0803D9D4: .4byte gUnk_080F59CC
_0803D9D8: .4byte gUnk_080F6B4C
_0803D9DC: .4byte gUnk_080F33B8
_0803D9E0: .4byte gUnk_080F61FC
_0803D9E4: .4byte gUnk_080F3408
_0803D9E8: .4byte gUnk_080F3FD8
_0803D9EC: .4byte gUnk_080F35E4
_0803D9F0: .4byte gUnk_080F3010
_0803D9F4: .4byte gUnk_080F5D94
_0803D9F8: .4byte gUnk_080F6DE8
_0803D9FC: .4byte gUnk_080F2AF8
_0803DA00: .4byte gUnk_080F42F0
_0803DA04: .4byte gUnk_080F43DC
_0803DA08: .4byte gUnk_080F6FF8
_0803DA0C: .4byte gUnk_080F7B40
_0803DA10: .4byte gUnk_080F2DC0
_0803DA14: .4byte gUnk_080F597C
_0803DA18: .4byte gUnk_080F6B10
_0803DA1C: .4byte gUnk_080F4974
_0803DA20: .4byte gUnk_080F29C0
