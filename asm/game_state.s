...
_08010FA2:
    ...
    lsls r0, r1, #0x1e
    lsrs r3, r0, #0x1e
    ldr r4, _080110EC @ =gUnk_080F0566
_08010FC2:
    adds r0, r2, r4
    ldrb r1, [r0]
    lsls r0, r1, #0x1e
...
func_08011650: @ 0x08011650
    ...
    adds r0, r7, #0
    adds r0, #0x14
    ldr r5, _08011874 @ =gUnk_080F058C
    adds r1, r5, #0
    bl __4FarmPCc
...
func_08011934: @ 0x08011934
    ...
    str r1, [sp, #0xc]
    mov sb, r2
    ldr r1, _080119AC @ =gUnk_080F0654
    mov r0, sp
    movs r2, #3
    bl memcpy
    add r0, sp, #4
    ldr r1, _080119B0 @ =gUnk_080F0658
    movs r2, #2
    bl memcpy
    movs r0, #1
    str r0, [sp, #0x10]
...
_0801197E:
    ...
    b _080119EA
    .align 2, 0
_080119AC: .4byte gUnk_080F0654
_080119B0: .4byte gUnk_080F0658
_080119B4:
    ldr r1, _08011ABC @ =gUnk_080F0654
    mov r8, r1
    mov r0, sb
    bl strlen
    mov r2, sb
...
_08011A24:
    ...
    cmp r1, #2
    bls _08011A64
    ldr r7, _08011AC4 @ =gUnk_080F0658
    mov r0, sb
    bl strlen
    mov r2, sb
    adds r6, r2, r0
...
_08011A8E:
    ...
    b _08011AFE
    .align 2, 0
_08011ABC: .4byte gUnk_080F0654
_08011AC0: .4byte 0x00000383
_08011AC4: .4byte gUnk_080F0658
_08011AC8:
    ldr r2, _08011BBC @ =gUnk_080F0654
    mov r8, r2
    mov r0, sb
    bl strlen
    mov r1, sb
...
_08011B38:
    ...
    cmp r0, #2
    bls _08011B78
    ldr r7, _08011BC4 @ =gUnk_080F0658
    mov r0, sb
    bl strlen
    mov r1, sb
    adds r6, r1, r0
...
_08011B8E:
    ...
    b _08011BFE
    .align 2, 0
_08011BBC: .4byte gUnk_080F0654
_08011BC0: .4byte 0x00000383
_08011BC4: .4byte gUnk_080F0658
_08011BC8:
    ldr r2, _08011CCC @ =gUnk_080F0654
    mov r8, r2
    mov r0, sb
    bl strlen
    mov r1, sb
...
_08011C38:
    ...
    cmp r0, #2
    bls _08011C78
    ldr r7, _08011CD4 @ =gUnk_080F0658
    mov r0, sb
    bl strlen
    mov r1, sb
    adds r6, r1, r0
...
_08011CBC:
    ...
    bx r0
    .align 2, 0
_08011CCC: .4byte gUnk_080F0654
_08011CD0: .4byte 0x00000383
_08011CD4: .4byte gUnk_080F0658
...
_08014DBE:
    ...
    mov r0, sp
    strb r7, [r0]
    ldr r1, _08015110 @ =gUnk_080F0654
    add r0, sp, #0x384
    movs r2, #3
    bl memcpy
    ldr r1, _08015114 @ =gUnk_080F0658
    add r0, sp, #0x388
    movs r2, #2
    bl memcpy
    ldr r1, _08015118 @ =gUnk_080F065C
    add r0, sp, #0x38c
    movs r2, #2
    bl memcpy
    mov sb, sp
    ldr r0, _0801511C @ =gUnk_080F0660
    mov r8, r0
    mov r0, sp
    bl strlen
    mov r1, sp
...
_08014E16:
    mov r6, sb
    ldr r0, _08015110 @ =gUnk_080F0654
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_08014E3A:
    ...
    strb r0, [r1]
_08014E4A:
    ldr r1, _08015124 @ =gUnk_080F067C
    mov r8, r1
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_08014EAA:
    ...
    strb r0, [r1]
_08014EBA:
    ldr r0, _08015128 @ =gUnk_080F0684
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_08014F0E:
    ...
    strb r0, [r1]
_08014F1E:
    ldr r0, _0801512C @ =gUnk_080F068C
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_08014FA4:
    ...
    strb r0, [r1]
_08014FB4:
    ldr r1, _08015130 @ =gUnk_080F069C
    mov r8, r1
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_08014FD6:
    ...
    strb r0, [r1]
_08014FE6:
    ldr r0, _08015114 @ =gUnk_080F0658
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_0801503A:
    ...
    strb r0, [r1]
_0801504A:
    ldr r7, _08015118 @ =gUnk_080F065C
    adds r0, r6, #0
    bl strlen
    adds r6, r6, r0
    ldr r1, _08015120 @ =0x00000383
...
_080150B8:
    mov r6, r8
    ldr r0, _08015134 @ =gUnk_080F06B4
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_08015110: .4byte gUnk_080F0654
_08015114: .4byte gUnk_080F0658
_08015118: .4byte gUnk_080F065C
_0801511C: .4byte gUnk_080F0660
_08015120: .4byte 0x00000383
_08015124: .4byte gUnk_080F067C
_08015128: .4byte gUnk_080F0684
_0801512C: .4byte gUnk_080F068C
_08015130: .4byte gUnk_080F069C
_08015134: .4byte gUnk_080F06B4
_08015138:
    bls _0801513C
    adds r4, r5, #0
_0801513C:
    ...
    strb r0, [r1]
_0801514C:
    ldr r0, _08015204 @ =gUnk_080F06D0
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_0801516E:
    ...
    strb r0, [r1]
_0801517E:
    ldr r7, _0801520C @ =gUnk_080F0658
    adds r0, r6, #0
    bl strlen
    adds r6, r6, r0
    ldr r1, _08015208 @ =0x00000383
...
_080151F0:
    ...
    bx r0
    .align 2, 0
_08015204: .4byte gUnk_080F06D0
_08015208: .4byte 0x00000383
_0801520C: .4byte gUnk_080F0658
...
_0801533E:
    ...
    mov r0, sp
    strb r7, [r0]
    ldr r1, _08015690 @ =gUnk_080F0654
    add r0, sp, #0x384
    movs r2, #3
    bl memcpy
    ldr r1, _08015694 @ =gUnk_080F0658
    add r0, sp, #0x388
    movs r2, #2
    bl memcpy
    ldr r1, _08015698 @ =gUnk_080F065C
    add r0, sp, #0x38c
    movs r2, #2
    bl memcpy
    mov sb, sp
    ldr r0, _0801569C @ =gUnk_080F0660
    mov r8, r0
    mov r0, sp
    bl strlen
    mov r1, sp
...
_08015396:
    mov r6, sb
    ldr r0, _08015690 @ =gUnk_080F0654
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_080153BA:
    ...
    strb r0, [r1]
_080153CA:
    ldr r1, _080156A4 @ =gUnk_080F067C
    mov r8, r1
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_0801542A:
    ...
    strb r0, [r1]
_0801543A:
    ldr r0, _080156A8 @ =gUnk_080F0684
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_0801548E:
    ...
    strb r0, [r1]
_0801549E:
    ldr r0, _080156AC @ =gUnk_080F068C
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_08015524:
    ...
    strb r0, [r1]
_08015534:
    ldr r1, _080156B0 @ =gUnk_080F069C
    mov r8, r1
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_08015556:
    ...
    strb r0, [r1]
_08015566:
    ldr r0, _08015694 @ =gUnk_080F0658
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_080155BA:
    ...
    strb r0, [r1]
_080155CA:
    ldr r7, _08015698 @ =gUnk_080F065C
    adds r0, r6, #0
    bl strlen
    adds r6, r6, r0
    ldr r1, _080156A0 @ =0x00000383
...
_08015638:
    mov r6, r8
    ldr r0, _080156B4 @ =gUnk_080F06B4
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_08015690: .4byte gUnk_080F0654
_08015694: .4byte gUnk_080F0658
_08015698: .4byte gUnk_080F065C
_0801569C: .4byte gUnk_080F0660
_080156A0: .4byte 0x00000383
_080156A4: .4byte gUnk_080F067C
_080156A8: .4byte gUnk_080F0684
_080156AC: .4byte gUnk_080F068C
_080156B0: .4byte gUnk_080F069C
_080156B4: .4byte gUnk_080F06B4
_080156B8:
    bls _080156BC
    adds r4, r5, #0
_080156BC:
    ...
    strb r0, [r1]
_080156CC:
    ldr r0, _08015784 @ =gUnk_080F06D0
    mov r8, r0
    adds r0, r6, #0
    bl strlen
    adds r7, r6, r0
...
_080156EE:
    ...
    strb r0, [r1]
_080156FE:
    ldr r7, _0801578C @ =gUnk_080F0658
    adds r0, r6, #0
    bl strlen
    adds r6, r6, r0
    ldr r1, _08015788 @ =0x00000383
...
_08015770:
    ...
    bx r0
    .align 2, 0
_08015784: .4byte gUnk_080F06D0
_08015788: .4byte 0x00000383
_0801578C: .4byte gUnk_080F0658
...
_080172DC:
    ldr r2, _080172F8 @ =gUnk_0810692C
    ldr r0, [sp, #0xc]
    cmp r0, #0
    beq _080172E6
    ldr r2, _080172FC @ =gUnk_08106944
_080172E6:
    movs r0, #3
    str r0, [sp]
    ldr r0, [sp, #4]
    ...
    b _0801733A
    .align 2, 0
_080172F8: .4byte gUnk_0810692C
_080172FC: .4byte gUnk_08106944
_08017300:
    ldr r2, _0801731C @ =gUnk_0810695C
    ldr r1, [sp, #0xc]
    cmp r1, #0
    beq _0801730A
    ldr r2, _08017320 @ =gUnk_08106974
_0801730A:
    movs r0, #3
    str r0, [sp]
    ldr r0, [sp, #4]
    ...
    b _0801733A
    .align 2, 0
_0801731C: .4byte gUnk_0810695C
_08017320: .4byte gUnk_08106974
_08017324:
    ldr r2, _08017350 @ =gUnk_0810698C
    ldr r1, [sp, #0xc]
    cmp r1, #0
    beq _0801732E
    ldr r2, _08017354 @ =gUnk_081069A4
_0801732E:
    str r0, [sp]
    ldr r0, [sp, #4]
    mov r1, sb
...
_0801733A:
    ...
    b _08017398
    .align 2, 0
_08017350: .4byte gUnk_0810698C
_08017354: .4byte gUnk_081069A4
_08017358: .4byte 0x000005DC
_0801735C:
    ldr r2, _08017378 @ =gUnk_081069BC
    ldr r0, [sp, #0xc]
    cmp r0, #0
    beq _08017366
    ldr r2, _0801737C @ =gUnk_081069D4
_08017366:
    movs r0, #2
    str r0, [sp]
    ldr r0, [sp, #4]
    ...
    b _08017398
    .align 2, 0
_08017378: .4byte gUnk_081069BC
_0801737C: .4byte gUnk_081069D4
_08017380:
    ldr r2, _080173B0 @ =gUnk_081069EC
    ldr r1, [sp, #0xc]
    cmp r1, #0
    beq _0801738A
    ldr r2, _080173B4 @ =gUnk_08106A04
_0801738A:
    movs r0, #2
    str r0, [sp]
    ldr r0, [sp, #4]
...
_08017398:
    ...
    b _080173F4
    .align 2, 0
_080173B0: .4byte gUnk_081069EC
_080173B4: .4byte gUnk_08106A04
_080173B8:
    ldr r2, _080173D4 @ =gUnk_08106A1C
    ldr r0, [sp, #0xc]
    cmp r0, #0
    beq _080173C2
    ldr r2, _080173D8 @ =gUnk_08106A34
_080173C2:
    movs r0, #0x34
    str r0, [sp]
    ldr r0, [sp, #4]
    ...
    b _080173F4
    .align 2, 0
_080173D4: .4byte gUnk_08106A1C
_080173D8: .4byte gUnk_08106A34
_080173DC:
    ldr r2, _08017404 @ =gUnk_08106A4C
    ldr r1, [sp, #0xc]
    cmp r1, #0
    beq _080173E6
    ldr r2, _08017408 @ =gUnk_08106A64
_080173E6:
    movs r0, #0x34
    str r0, [sp]
    ldr r0, [sp, #4]
...
_080173F4:
    ...
    bx r0
    .align 2, 0
_08017404: .4byte gUnk_08106A4C
_08017408: .4byte gUnk_08106A64
...
_08018ED4:
    ...
    mov r0, sb
    bl _call_via_r1
    ldr r4, _08018F70 @ =gUnk_080F06FD
    lsls r5, r5, #1
    adds r1, r5, r4
    ldrb r1, [r1]
    lsls r1, r1, #3
...
_08018FCA:
    ...
    mov r0, sb
    bl _call_via_r1
    ldr r4, _0801905C @ =gUnk_080F06FD
    ldrb r1, [r4]
    lsls r1, r1, #3
    subs r1, r1, r0
    mov r8, r1
...
_0801E69C:
    ...
    b _0801E8F6
_0801E6A2:
    ldr r1, _0801E6AC @ =gUnk_080F0704
    str r1, [sp, #0x14]
    movs r1, #5
    b _0801E6BE
    .align 2, 0
_0801E6AC: .4byte gUnk_080F0704
_0801E6B0:
    ldr r1, _0801E6B4 @ =gUnk_080F0718
    b _0801E6BA
    .align 2, 0
_0801E6B4: .4byte gUnk_080F0718
_0801E6B8:
    ldr r1, _0801E70C @ =gUnk_080F0730
_0801E6BA:
    str r1, [sp, #0x14]
    movs r1, #6
_0801E6BE:
...
_0801EB0E:
    ...
    movs r3, #0
    adds r4, r6, #0
    ldr r2, _0801EBBC @ =gUnk_080F0748
_0801EB18:
    ldr r0, [r2]
    lsls r0, r0, #2
    adds r0, r4, r0
...
_0801EB3C:
    ...
    str r0, [r1]
    movs r5, #0
    ldr r4, _0801EBC0 @ =gUnk_080F0770
_0801EB5E:
    ldr r0, [r4]
    lsls r0, r0, #2
    adds r0, r6, r0
...
_0801EBBC: .4byte gUnk_080F0748
_0801EBC0: .4byte gUnk_080F0770
_0801EBC4:
    movs r0, #0
    mov r1, r8
    strb r0, [r1, #4]
