...
_080D8D3E:
	...
	bl func_08050D68
	ldr r0, [r6]
	ldr r1, _080D8D8C @ =gUnk_080F05B8
	ldr r2, _080D8D90 @ =gUnk_080F05C0
	ldr r3, _080D8D94 @ =gUnk_080F05C8
	ldr r5, _080D8D98 @ =gUnk_080F05D4
	movs r4, #0
	str r5, [sp]
	str r4, [sp, #4]
	str r4, [sp, #8]
...
_080D8D8C: .4byte gUnk_080F05B8
_080D8D90: .4byte gUnk_080F05C0
_080D8D94: .4byte gUnk_080F05C8
_080D8D98: .4byte gUnk_080F05D4
...
_080D9986:
	ldr r0, [r4]
	ldr r1, _080D99A4 @ =gUnk_080F05B8
	ldr r2, _080D99A8 @ =gUnk_080F05C0
	ldr r3, _080D99AC @ =gUnk_080F05C8
	ldr r5, _080D99B0 @ =gUnk_080F05D4
	movs r4, #0
	str r5, [sp]
	str r4, [sp, #4]
	str r4, [sp, #8]
	...
	bl _080DAABA
	.align 2, 0
_080D99A4: .4byte gUnk_080F05B8
_080D99A8: .4byte gUnk_080F05C0
_080D99AC: .4byte gUnk_080F05C8
_080D99B0: .4byte gUnk_080F05D4
_080D99B4:
...
_080DA9EC:
	...
	str r0, [r1, #0xc]
_080DA9FE:
	ldr r1, _080DAA4C @ =gUnk_080F05D9
	movs r2, #0xaf
	lsls r2, r2, #3
	add r2, sp
	ldr r2, [r2]
...
func_080DCB7C: @ 0x080DCB7C
	...
	cmp r3, #0
	beq _080DCBB8
	ldr r0, _080DCBB4 @ =gUnk_080F1684
	ldrh r2, [r0, #2]
	b _080DCBBC
	.align 2, 0
_080DCBB4: .4byte gUnk_080F1684
_080DCBB8:
	ldr r0, _080DCC90 @ =gUnk_080F1684
	ldrh r2, [r0]
_080DCBBC:
	movs r0, #6
	str r0, [sp]
...
_080DCC32:
	...
	bl __umodsi3
	adds r5, r0, #0
	ldr r4, _080DCC98 @ =gUnk_080F1672
	bl rand
	movs r1, #3
	bl __modsi3
	adds r0, r0, r4
	...
	bl __modsi3
	lsls r0, r0, #2
	ldr r1, _080DCC9C @ =gUnk_080F1678
	adds r0, r0, r1
	ldr r0, [r0]
	mov sb, r0
	mov r2, sl
	...
	beq _080DCCA0
	lsls r0, r6, #3
	ldr r2, _080DCC90 @ =gUnk_080F1684
	adds r0, r0, r2
	ldrh r2, [r0, #2]
	b _080DCCA8
	.align 2, 0
_080DCC90: .4byte gUnk_080F1684
_080DCC94: .4byte 0x00002666
_080DCC98: .4byte gUnk_080F1672
_080DCC9C: .4byte gUnk_080F1678
_080DCCA0:
	lsls r0, r6, #3
	ldr r3, _080DCD28 @ =gUnk_080F1684
	adds r0, r0, r3
	ldrh r2, [r0]
_080DCCA8:
	movs r0, #6
	...
	str r0, [r7, #0x48]
	lsls r0, r6, #3
	ldr r1, _080DCD28 @ =gUnk_080F1684
	adds r0, r0, r1
	ldrb r1, [r0, #4]
	adds r0, r7, #0
	adds r0, #0x4c
...
_080DE8E4:
	...
	b _080DE8FE
_080DE8FC:
	ldr r1, _080DE920 @ =gUnk_080F19A0
_080DE8FE:
	movs r0, #0xdb
	lsls r0, r0, #2
	add r0, r8
...
_080DE93A:
	...
	b _080DE954
_080DE952:
	ldr r1, _080DE978 @ =gUnk_080F19A0
_080DE954:
	movs r0, #0xdb
	lsls r0, r0, #2
	add r0, r8
...
_080DE992:
	...
	b _080DE9AC
_080DE9AA:
	ldr r1, _080DE9D0 @ =gUnk_080F19A0
_080DE9AC:
	movs r0, #0xdb
	lsls r0, r0, #2
	add r0, r8
...
_080DEA14:
	...
	b _080DEA30
_080DEA2E:
	ldr r6, _080DEA44 @ =gUnk_080F19A0
_080DEA30:
	ldr r0, [r4, #0x10]
	cmp r5, r0
	bhi _080DEA48
	...
	b _080DEA4A
	.align 2, 0
_080DEA44: .4byte gUnk_080F19A0
_080DEA48:
	ldr r2, _080DEA60 @ =gUnk_080F19A0
_080DEA4A:
	ldr r0, [r4, #0x10]
	cmp r7, r0
	bhi _080DEA64
	...
	b _080DEA66
	.align 2, 0
_080DEA60: .4byte gUnk_080F19A0
_080DEA64:
	ldr r3, _080DEAA0 @ =gUnk_080F19A0
_080DEA66:
	movs r1, #0
	movs r0, #0xdb
	lsls r0, r0, #2
...
_080DEAF8:
	...
	b _080DEB14
_080DEB12:
	ldr r5, _080DEB28 @ =gUnk_080F19A0
_080DEB14:
	ldr r0, [r4, #0x10]
	cmp r6, r0
	bhi _080DEB2C
	...
	b _080DEB2E
	.align 2, 0
_080DEB28: .4byte gUnk_080F19A0
_080DEB2C:
	ldr r2, _080DEB44 @ =gUnk_080F19A0
_080DEB2E:
	ldr r0, [r4, #0x10]
	cmp r7, r0
	bhi _080DEB48
	...
	b _080DEB4A
	.align 2, 0
_080DEB44: .4byte gUnk_080F19A0
_080DEB48:
	ldr r3, _080DEB60 @ =gUnk_080F19A0
_080DEB4A:
	ldr r0, [r4, #0x10]
	cmp sb, r0
	bhi _080DEB64
	...
	b _080DEB66
	.align 2, 0
_080DEB60: .4byte gUnk_080F19A0
_080DEB64:
	ldr r1, _080DEB9C @ =gUnk_080F19A0
_080DEB66:
	movs r4, #0
	movs r0, #0xdb
	lsls r0, r0, #2
...
_080DEC20:
	...
	b _080DEC3C
_080DEC3A:
	ldr r6, _080DEC50 @ =gUnk_080F19A0
_080DEC3C:
	ldr r0, [r4, #0x10]
	cmp r5, r0
	bhi _080DEC54
	...
	b _080DEC56
	.align 2, 0
_080DEC50: .4byte gUnk_080F19A0
_080DEC54:
	ldr r2, _080DEC6C @ =gUnk_080F19A0
_080DEC56:
	ldr r0, [r4, #0x10]
	cmp r7, r0
	bhi _080DEC70
	...
	b _080DEC72
	.align 2, 0
_080DEC6C: .4byte gUnk_080F19A0
_080DEC70:
	ldr r3, _080DEC88 @ =gUnk_080F19A0
_080DEC72:
	ldr r0, [r4, #0x10]
	cmp sb, r0
	bhi _080DEC8C
	...
	b _080DEC8E
	.align 2, 0
_080DEC88: .4byte gUnk_080F19A0
_080DEC8C:
	ldr r5, _080DECA4 @ =gUnk_080F19A0
_080DEC8E:
	ldr r0, [r4, #0x10]
	cmp sl, r0
	bhi _080DECA8
	...
	b _080DECAA
	.align 2, 0
_080DECA4: .4byte gUnk_080F19A0
_080DECA8:
	ldr r1, _080DECD8 @ =gUnk_080F19A0
_080DECAA:
	movs r0, #0xdb
	lsls r0, r0, #2
	add r0, r8
...
_080DED3A:
	...
	b _080DED56
_080DED54:
	ldr r3, _080DED6C @ =gUnk_080F19A0
_080DED56:
	ldr r0, [r4, #0x10]
	cmp r5, r0
	bhi _080DED70
	...
	b _080DED72
	.align 2, 0
_080DED6C: .4byte gUnk_080F19A0
_080DED70:
	ldr r2, _080DEDB0 @ =gUnk_080F19A0
_080DED72:
	movs r1, #0
	movs r0, #0xdb
	lsls r0, r0, #2
...
_080DEDF4:
	...
	b _080DEE10
_080DEE0E:
	ldr r5, _080DEE24 @ =gUnk_080F19A0
_080DEE10:
	ldr r0, [r4, #0x10]
	cmp r6, r0
	bhi _080DEE28
	...
	b _080DEE2A
	.align 2, 0
_080DEE24: .4byte gUnk_080F19A0
_080DEE28:
	ldr r2, _080DEE40 @ =gUnk_080F19A0
_080DEE2A:
	ldr r0, [r4, #0x10]
	cmp r7, r0
	bhi _080DEE44
	...
	b _080DEE46
	.align 2, 0
_080DEE40: .4byte gUnk_080F19A0
_080DEE44:
	ldr r3, _080DEE80 @ =gUnk_080F19A0
_080DEE46:
	movs r1, #0
	movs r0, #0xdb
	lsls r0, r0, #2
...
_080DEEF2:
	...
	b _080DEF0E
_080DEF0C:
	ldr r5, _080DEF24 @ =gUnk_080F19A0
_080DEF0E:
	ldr r0, [r4, #0x10]
	cmp r6, r0
	bhi _080DEF28
	...
	b _080DEF2A
	.align 2, 0
_080DEF24: .4byte gUnk_080F19A0
_080DEF28:
	ldr r2, _080DEF40 @ =gUnk_080F19A0
_080DEF2A:
	ldr r0, [r4, #0x10]
	cmp r7, r0
	bhi _080DEF44
	...
	b _080DEF46
	.align 2, 0
_080DEF40: .4byte gUnk_080F19A0
_080DEF44:
	ldr r3, _080DEF5C @ =gUnk_080F19A0
_080DEF46:
	ldr r0, [r4, #0x10]
	cmp sb, r0
	bhi _080DEF60
	...
	b _080DEF62
	.align 2, 0
_080DEF5C: .4byte gUnk_080F19A0
_080DEF60:
	ldr r1, _080DEF9C @ =gUnk_080F19A0
_080DEF62:
	movs r4, #0
	movs r0, #0xdb
	lsls r0, r0, #2
...
_080DF036:
	...
	b _080DF052
_080DF050:
	ldr r6, _080DF068 @ =gUnk_080F19A0
_080DF052:
	ldr r0, [r4, #0x10]
	cmp r5, r0
	bhi _080DF06C
	...
	b _080DF06E
	.align 2, 0
_080DF068: .4byte gUnk_080F19A0
_080DF06C:
	ldr r2, _080DF084 @ =gUnk_080F19A0
_080DF06E:
	ldr r0, [r4, #0x10]
	cmp r7, r0
	bhi _080DF088
	...
	b _080DF08A
	.align 2, 0
_080DF084: .4byte gUnk_080F19A0
_080DF088:
	ldr r3, _080DF0A0 @ =gUnk_080F19A0
_080DF08A:
	ldr r0, [r4, #0x10]
	cmp sb, r0
	bhi _080DF0A4
	...
	b _080DF0A6
	.align 2, 0
_080DF0A0: .4byte gUnk_080F19A0
_080DF0A4:
	ldr r5, _080DF0BC @ =gUnk_080F19A0
_080DF0A6:
	ldr r0, [r4, #0x10]
	cmp sl, r0
	bhi _080DF0C0
	...
	b _080DF0C2
	.align 2, 0
_080DF0BC: .4byte gUnk_080F19A0
_080DF0C0:
	ldr r1, _080DF0FC @ =gUnk_080F19A0
_080DF0C2:
	movs r4, #0
	movs r0, #0xdb
	lsls r0, r0, #2
...
_080DF1B2:
	...
	b _080DF1CE
_080DF1CC:
	ldr r7, _080DF1E4 @ =gUnk_080F19A0
_080DF1CE:
	ldr r0, [r4, #0x10]
	cmp r5, r0
	bhi _080DF1E8
	...
	b _080DF1EA
	.align 2, 0
_080DF1E4: .4byte gUnk_080F19A0
_080DF1E8:
	ldr r2, _080DF200 @ =gUnk_080F19A0
_080DF1EA:
	ldr r0, [r4, #0x10]
	cmp r6, r0
	bhi _080DF204
	...
	b _080DF206
	.align 2, 0
_080DF200: .4byte gUnk_080F19A0
_080DF204:
	ldr r3, _080DF21C @ =gUnk_080F19A0
_080DF206:
	ldr r0, [r4, #0x10]
	cmp sb, r0
	bhi _080DF220
	...
	b _080DF222
	.align 2, 0
_080DF21C: .4byte gUnk_080F19A0
_080DF220:
	ldr r6, _080DF238 @ =gUnk_080F19A0
_080DF222:
	ldr r0, [r4, #0x10]
	cmp sl, r0
	bhi _080DF23C
	...
	b _080DF23E
	.align 2, 0
_080DF238: .4byte gUnk_080F19A0
_080DF23C:
	ldr r5, _080DF258 @ =gUnk_080F19A0
_080DF23E:
	ldr r0, [r4, #0x10]
	cmp ip, r0
	bhi _080DF25C
	...
	b _080DF25E
	.align 2, 0
_080DF258: .4byte gUnk_080F19A0
_080DF25C:
	ldr r1, _080DF298 @ =gUnk_080F19A0
_080DF25E:
	movs r0, #0xdb
	lsls r0, r0, #2
	add r0, r8
...
_080DFD0C:
	mov r0, r8
	adds r0, #0xc
	ldr r2, _080DFD20 @ =gUnk_080F89D4
	lsls r1, r1, #2
	adds r1, r1, r2
	ldr r1, [r1]
...
_080E03A4:
	...
	str r0, [r5, #0xc]
_080E03AE:
	ldr r2, _080E0534 @ =gUnk_080F89D4
	ldr r1, _080E0538 @ =gUnk_080F19AE
	movs r3, #0xd8
	lsls r3, r3, #2
	adds r0, r7, r3
	ldr r0, [r0]
...
_080E0528:
	...
	mov pc, r0
	.align 2, 0
_080E0534: .4byte gUnk_080F89D4
_080E0538: .4byte gUnk_080F19AE
...
func_080E0A94: @ 0x080E0A94
	...
	push {r6, r7}
	adds r7, r0, #0
	ldr r1, _080E0C2C @ =gUnk_0871E7A8
	bl func_0805E6CC
	adds r4, r7, #0
	adds r4, #0x30
	adds r0, r4, #0
...
_080E0B98:
	...
	bl __builtin_new
	adds r4, r0, #0
	ldr r1, _080E0C34 @ =gUnk_080F19CC
	mov r2, r8
	lsls r0, r2, #2
	adds r0, r0, r1
	ldr r5, [r0]
...
_080E0C08:
	...
	bx r1
	.align 2, 0
_080E0C2C: .4byte gUnk_0871E7A8
_080E0C30: .4byte vtable_unk_080E77D0
_080E0C34: .4byte gUnk_080F19CC
...
_080E1536:
	...
	adds r5, r1, #0
	muls r5, r0, r5
	ldr r0, _080E1574 @ =gUnk_080FA796
	adds r5, r5, r0
	adds r0, r5, #0
	bl strlen
	adds r4, r0, #0
...
func_080E1844: @ 0x080E1844
	...
	adds r1, r1, r0
	lsls r1, r1, #2
	ldr r0, _080E1888 @ =gUnk_080FB000
	adds r5, r1, r0
	adds r0, r5, #0
	bl strlen
	adds r4, r0, #0
...
_080E2C12:
	...
	lsrs r0, r2, #0x1e
	adds r1, r1, r0
	ldr r2, _080E2C84 @ =gUnk_080FC066
	lsrs r0, r1, #1
	adds r0, r0, r2
	ldrb r2, [r0]
	movs r0, #1
...
func_080E35E8: @ 0x080E35E8
	...
	lsls r0, r0, #1
	adds r4, r4, r0
	ldr r1, _080E360C @ =gUnk_081004E0
	adds r0, r4, #0
	movs r2, #0
	movs r3, #0
	bl func_08050DC8
...
func_080E3628: @ 0x080E3628
	...
	lsls r0, r0, #1
	adds r4, r4, r0
	ldr r1, _080E364C @ =gUnk_08100524
	adds r0, r4, #0
	movs r2, #0
	movs r3, #0
	bl func_08050DC8
...
func_080E3650: @ 0x080E3650
	...
	lsls r0, r0, #1
	adds r4, r4, r0
	ldr r1, _080E3674 @ =gUnk_08100540
	adds r0, r4, #0
	movs r2, #0
	movs r3, #0
	bl func_08050DC8
...
func_080E3678: @ 0x080E3678
	...
	lsls r0, r0, #1
	adds r4, r2, r0
	ldr r1, _080E36B0 @ =gUnk_08100558
	adds r0, r4, #0
	movs r2, #0
	movs r3, #0
	bl func_08050DC8
...
_080E36CC:
	...
	movs r0, #1
	str r0, [r4]
	ldr r1, _080E36F4 @ =gUnk_08100588
	ldr r2, _080E36F8 @ =gUnk_0810058C
	ldr r3, _080E36FC @ =gUnk_08100590
	str r6, [sp]
	str r6, [sp, #4]
	str r6, [sp, #8]
	adds r0, r5, #0
	...
	b _080E3726
	.align 2, 0
_080E36F4: .4byte gUnk_08100588
_080E36F8: .4byte gUnk_0810058C
_080E36FC: .4byte gUnk_08100590
_080E3700:
	movs r1, #0xe4
	lsls r1, r1, #1
	adds r4, r0, r1
...
func_080E3734: @ 0x080E3734
	...
	lsls r0, r0, #1
	adds r4, r4, r0
	ldr r1, _080E3758 @ =gUnk_08100594
	adds r0, r4, #0
	movs r2, #0
	movs r3, #0
	bl func_08050DC8
...
func_080E3774: @ 0x080E3774
	...
	lsls r0, r0, #1
	adds r4, r4, r0
	ldr r1, _080E3794 @ =gUnk_081005D8
	adds r0, r4, #0
	bl func_08050D8C
	adds r0, r4, #0
	movs r1, #0x38
...
func_080E379C: @ 0x080E379C
	...
	lsls r0, r0, #1
	adds r4, r5, r0
	ldr r1, _080E37D8 @ =gUnk_081005EC
	adds r0, r4, #0
	bl func_08050D8C
	adds r0, r4, #0
	movs r1, #0x3a
...
_080E37F6:
	...
	lsls r2, r2, #1
	adds r0, r1, r2
	ldr r1, _080E3820 @ =gUnk_0810058C
	ldr r2, _080E3824 @ =gUnk_08100590
	str r4, [sp]
	str r4, [sp, #4]
	str r4, [sp, #8]
	str r4, [sp, #0xc]
	...
	b _080E384E
	.align 2, 0
_080E3820: .4byte gUnk_0810058C
_080E3824: .4byte gUnk_08100590
_080E3828:
	movs r3, #0xea
	lsls r3, r3, #1
	adds r0, r1, r3
...
_080E3B9A:
	...
	lsls r1, r1, #2
	adds r1, r1, r0
	ldr r0, _080E3BAC @ =gUnk_08100AD2
	adds r5, r1, r0
	adds r0, r5, #0
	b _080E3BF6
	.align 2, 0
_080E3BAC: .4byte gUnk_08100AD2
_080E3BB0:
	ldrb r0, [r1, #7]
	lsls r1, r0, #3
	subs r1, r1, r0
	lsls r1, r1, #2
	adds r1, r1, r0
	ldr r0, _080E3BC4 @ =gUnk_08100BD7
	adds r5, r1, r0
	adds r0, r5, #0
	b _080E3BF6
	.align 2, 0
_080E3BC4: .4byte gUnk_08100BD7
_080E3BC8:
	ldrh r0, [r1, #4]
	cmp r0, #0xab
	bhi _080E3BE2
...
_080E3F70:
	...
	b _080E4086
_080E3F7A:
	ldr r7, _080E3FA8 @ =gUnk_08104938
	adds r0, r7, #0
	bl strlen
	adds r4, r0, #0
	cmp r4, #0x1f
...
_080E3F8A:
	...
	b _080E4094
	.align 2, 0
_080E3FA8: .4byte gUnk_08104938
_080E3FAC:
	ldr r7, _080E3FD4 @ =gUnk_08104940
	adds r0, r7, #0
	bl strlen
	adds r4, r0, #0
	cmp r4, #0x1f
...
_080E3FBC:
	...
	b _080E4006
	.align 2, 0
_080E3FD4: .4byte gUnk_08104940
_080E3FD8:
	ldr r5, _080E3FDC @ =gUnk_08104948
	b _080E3FE2
	.align 2, 0
_080E3FDC: .4byte gUnk_08104948
_080E3FE0:
	ldr r5, _080E4010 @ =gUnk_08104950
_080E3FE2:
	adds r0, r5, #0
	bl strlen
	adds r4, r0, #0
