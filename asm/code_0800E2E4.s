    ...
    thumb_func_start func_0800E2E4
func_0800E2E4: @ 0x0800E2E4
    push {lr}
    adds r1, r0, #0
    cmp r1, #3
    bls _0800E2F4
...
_0800E350:
    ...
    thumb_func_start func_0800E354
func_0800E354: @ 0x0800E354
    push {r4, r5, r6, r7, lr}
    mov r7, sl
    mov r6, sb
    mov r5, r8
...
_0800E4DC: .4byte 0xFFFFE000
    ...
    thumb_func_start func_0800E4E0
func_0800E4E0: @ 0x0800E4E0
    bx lr
    .align 2, 0

    thumb_func_start func_0800E4E4
func_0800E4E4: @ 0x0800E4E4
    adds r0, #0x10
    bx lr

    thumb_func_start func_0800E4E8
func_0800E4E8: @ 0x0800E4E8
    adds r0, #0x20
    ldrb r0, [r0]
    bx lr
    .align 2, 0

    thumb_func_start func_0800E4F0
func_0800E4F0: @ 0x0800E4F0
    adds r0, #0x44
    ldrh r0, [r0]
    lsls r0, r0, #0x11
    lsrs r0, r0, #0x18
    ...
    thumb_func_start func_0800E4FC
func_0800E4FC: @ 0x0800E4FC
    ldr r0, [r0, #0x44]
    lsls r0, r0, #9
    lsrs r0, r0, #0x19
    bx lr
_0800E504:
    ...
    thumb_func_start func_0800E51C
func_0800E51C: @ 0x0800E51C
    adds r0, #0x44
    ldrb r1, [r0]
    lsls r1, r1, #0x1c
    lsrs r1, r1, #0x1c
    ...
    thumb_func_start func_0800E530
func_0800E530: @ 0x0800E530
    adds r0, #0x44
    ldrb r0, [r0]
    lsls r0, r0, #0x1c
    lsrs r0, r0, #0x1c
    ...
    thumb_func_start func_0800E53C
func_0800E53C: @ 0x0800E53C
    adds r0, #0x44
    ldrb r0, [r0]
    lsls r0, r0, #0x1b
    lsrs r0, r0, #0x1f
    ...
    thumb_func_start func_0800E548
func_0800E548: @ 0x0800E548
    lsls r1, r1, #2
    adds r1, #0x2c
    adds r0, r0, r1
    bx lr

    thumb_func_start func_0800E550
func_0800E550: @ 0x0800E550
    push {r4, lr}
    sub sp, #0x20
    adds r4, r0, #0
    mov r0, sp
...
_0800E91A:
    ...
    thumb_func_start func_0800E924
func_0800E924: @ 0x0800E924
    push {r4, lr}
    adds r2, r0, #0
    adds r1, #0x24
    ldm r1!, {r3, r4}
    ...
    thumb_func_start func_0800E934
func_0800E934: @ 0x0800E934
    adds r0, #0x44
    ldrb r0, [r0]
    lsls r0, r0, #0x1a
    lsrs r0, r0, #0x1f
    ...
    thumb_func_start func_0800E940
func_0800E940: @ 0x0800E940
    adds r0, #0x44
    ldrb r0, [r0]
    lsls r0, r0, #0x19
    lsrs r0, r0, #0x1f
    ...
    thumb_func_start func_0800E94C
func_0800E94C: @ 0x0800E94C
    adds r0, #0x46
    ldrh r0, [r0]
    lsls r0, r0, #0x11
    lsrs r0, r0, #0x18
    ...
    thumb_func_start func_0800E958
func_0800E958: @ 0x0800E958
    adds r1, r0, #0
    adds r1, #0x47
    ldrb r2, [r1]
    lsrs r2, r2, #7
...
func_0800E970: @ 0x0800E970
    ...
    thumb_func_start func_0800E97C
func_0800E97C: @ 0x0800E97C
    adds r0, #0x4c
    ldrh r0, [r0]
    lsls r0, r0, #0x11
    lsrs r0, r0, #0x18
    ...
    thumb_func_start func_0800E988
func_0800E988: @ 0x0800E988
    ldr r2, [r0, #0x4c]
    lsrs r2, r2, #0xf
    adds r0, #0x50
    ldrh r0, [r0]
...
_0800E99C: .4byte 0x00001FFF
    ...
    thumb_func_start func_0800E9A0
func_0800E9A0: @ 0x0800E9A0
    adds r0, #0x51
    ldrb r0, [r0]
    lsrs r0, r0, #5
    bx lr

    thumb_func_start func_0800E9A8
func_0800E9A8: @ 0x0800E9A8
    push {r4, r5, r6, lr}
    sub sp, #0x10
    adds r6, r0, #0
    adds r5, r1, #0
...
_0800E9BE:
    ...
    thumb_func_start func_0800E9E4
func_0800E9E4: @ 0x0800E9E4
    push {r4, lr}
    sub sp, #8
    adds r3, r0, #0
    adds r4, r3, #0
...
_0800EA38:
    ...
    thumb_func_start func_0800EA68
func_0800EA68: @ 0x0800EA68
    push {r4, r5, lr}
    sub sp, #8
    adds r5, r0, #0
    adds r3, r1, #0
...
_0800EAD4:
    ...
    thumb_func_start func_0800EAF0
func_0800EAF0: @ 0x0800EAF0
    adds r0, #0x44
    ldrb r1, [r0]
    movs r2, #0x10
    orrs r1, r2
    ...
    thumb_func_start func_0800EAFC
func_0800EAFC: @ 0x0800EAFC
    push {r4, lr}
    adds r4, r0, #0
    adds r3, r4, #0
    adds r3, #0x44
...
_0800EB26:
    ...
    thumb_func_start func_0800EB2C
func_0800EB2C: @ 0x0800EB2C
    lsls r1, r1, #2
    adds r1, #0x2c
    adds r0, r0, r1
    bx lr

    thumb_func_start func_0800EB34
func_0800EB34: @ 0x0800EB34
    adds r0, #0x24
    ldm r1!, {r2, r3}
    stm r0!, {r2, r3}
    bx lr

    thumb_func_start func_0800EB3C
func_0800EB3C: @ 0x0800EB3C
    push {r4, r5, r6, r7, lr}
    sub sp, #0xc
    adds r6, r0, #0
    adds r0, #0x60
...
_0800EBBA:
    ...
    thumb_func_start func_0800EBC4
func_0800EBC4: @ 0x0800EBC4
    push {r4, r5, r6, r7, lr}
    sub sp, #0xc
    adds r6, r0, #0
    adds r0, #0x60
...
_0800EC42:
    ...
    thumb_func_start func_0800EC4C
func_0800EC4C: @ 0x0800EC4C
    push {r4, r5, r6, r7, lr}
    mov r7, r8
    push {r7}
    sub sp, #8
...
_0800ECA2:
    ...
    thumb_func_start func_0800ECB0
func_0800ECB0: @ 0x0800ECB0
    push {r4, r5, r6, r7, lr}
    mov r7, r8
    push {r7}
    sub sp, #8
...
func_0800ED20: @ 0x0800ED20
    ...
    thumb_func_start func_0800ED2C
func_0800ED2C: @ 0x0800ED2C
    adds r0, #0x44
    ldrb r2, [r0]
    movs r1, #0x41
    rsbs r1, r1, #0
...
_0800ED50: .4byte 0xFFFF807F
    ...
    thumb_func_start func_0800ED54
func_0800ED54: @ 0x0800ED54
    push {lr}
    adds r3, r0, #0
    adds r0, #0x46
    ldrh r0, [r0]
...
_0800ED88: .4byte 0xFFFF807F
    ...
    thumb_func_start func_0800ED8C
func_0800ED8C: @ 0x0800ED8C
    push {r4, r5, r6, lr}
    sub sp, #4
    adds r5, r0, #0
    adds r0, #0x47
...
_0800EE28: .4byte 0x3B9AC9FF
    ...
    thumb_func_start func_0800EE2C
func_0800EE2C: @ 0x0800EE2C
    push {r4, r5, r6, lr}
    movs r5, #0
    adds r4, r0, #0
    adds r4, #0x4b
...
_0800EE58:
    ...
    thumb_func_start func_0800EE60
func_0800EE60: @ 0x0800EE60
    push {r4, lr}
    adds r3, r0, #0
    ldr r0, [r3, #0x44]
    movs r1, #0xff
...
_0800EEC6:
    ...
    thumb_func_start func_0800EECC
func_0800EECC: @ 0x0800EECC
    push {lr}
    adds r3, r0, #0
    adds r3, #0x4c
    ldrh r2, [r3]
...
_0800EEF4: .4byte 0xFFFF807F
    ...
    thumb_func_start func_0800EEF8
func_0800EEF8: @ 0x0800EEF8
    push {r4, r5, r6, lr}
    adds r3, r0, #0
    ldr r5, [r3, #0x4c]
    lsrs r0, r5, #0xf
...
_0800EF40: .4byte 0xFFFFE000
    ...
    thumb_func_start func_0800EF44
func_0800EF44: @ 0x0800EF44
    movs r1, #0
    strh r1, [r0]
    ldrb r1, [r0, #2]
    movs r3, #8
    ...
    thumb_func_start func_0800EF68
func_0800EF68: @ 0x0800EF68
    ldrh r0, [r0]
    bx lr

    thumb_func_start func_0800EF6C
func_0800EF6C: @ 0x0800EF6C
    ldr r0, [r0]
    lsls r0, r0, #0xd
    lsrs r0, r0, #0x1d
    bx lr

    thumb_func_start func_0800EF74
func_0800EF74: @ 0x0800EF74
    ldr r1, [r0]
    lsls r0, r1, #0xa
    lsls r1, r1, #0xd
    eors r1, r0
    ...
    thumb_func_start func_0800EF88
func_0800EF88: @ 0x0800EF88
    push {r4, lr}
    sub sp, #8
    adds r4, r0, #0
    ldrh r0, [r4]
...
_0800EFB0: .4byte 0x0000FFFF
    ...
    thumb_func_start func_0800EFB4
func_0800EFB4: @ 0x0800EFB4
    push {lr}
    adds r3, r0, #0
    ldr r0, [r3]
    lsls r0, r0, #0xd
...
_0800EFD4:
    ...
    thumb_func_start func_0800EFD8
func_0800EFD8: @ 0x0800EFD8
    ldr r2, [r0]
    lsls r2, r2, #0xa
    lsrs r2, r2, #0x1d
    ldrb r3, [r0, #2]
