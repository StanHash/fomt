    ...
    thumb_func_start func_0809BFE8
func_0809BFE8: @ 0x0809BFE8
    push {r4, r5, r6, lr}
    mov r6, r8
    push {r6}
    sub sp, #0x10
...
_0809C05C: .4byte 0xFFFFFC00
    ...
    thumb_func_start func_0809C060
func_0809C060: @ 0x0809C060
    ldrb r0, [r0, #8]
    lsls r0, r0, #0x19
    lsrs r0, r0, #0x19
    bx lr

    thumb_func_start func_0809C068
func_0809C068: @ 0x0809C068
    push {lr}
    adds r3, r0, #0
    ldrb r0, [r3, #8]
    lsls r0, r0, #0x19
...
_0809C082:
    ...
    thumb_func_start func_0809C098
func_0809C098: @ 0x0809C098
    movs r1, #0
    str r1, [r0, #0xc]
    bx lr
    .align 2, 0
...
func_0809C3E0: @ 0x0809C3E0
    ...
    adds r0, #0xc
    adds r4, r0, r1
    ldr r0, _0809C408 @ =gUnk_081036C0
    adds r0, r1, r0
    ldrb r3, [r4]
    ldrb r0, [r0]
    cmp r3, r0
...
_0809C534:
    ...
    cmp r3, #0
    beq _0809C554
    ldr r0, _0809C54C @ =gUnk_081036D4
    adds r0, #0x9c
    ldrb r1, [r0, #8]
    ldrb r2, [r0, #9]
    ldr r0, _0809C550 @ =gUnk_081070AC
    b _0809C5A0
    .align 2, 0
_0809C54C: .4byte gUnk_081036D4
_0809C550: .4byte gUnk_081070AC
_0809C554:
    ldr r2, _0809C570 @ =gUnk_081036D4
    lsls r0, r4, #1
    adds r0, r0, r4
    lsls r0, r0, #2
    adds r1, r2, #4
    ...
    b _0809C5A6
    .align 2, 0
_0809C570: .4byte gUnk_081036D4
_0809C574:
    cmp r4, #0xd
    bne _0809C590
    cmp r6, #0
    beq _0809C590
    ldr r0, _0809C588 @ =gUnk_081036D4
    adds r0, #0x9c
    ldrb r1, [r0, #8]
    ldrb r2, [r0, #9]
    ldr r0, _0809C58C @ =gUnk_08107094
    b _0809C5A0
    .align 2, 0
_0809C588: .4byte gUnk_081036D4
_0809C58C: .4byte gUnk_08107094
_0809C590:
    ldr r1, _0809C5B0 @ =gUnk_081036D4
    lsls r0, r4, #1
    adds r0, r0, r4
    lsls r0, r0, #2
    adds r0, r0, r1
...
func_0809CE7C: @ 0x0809CE7C
    ldr r0, _0809CE88 @ =gUnk_08103A18
    lsls r1, r1, #2
    adds r1, r1, r0
    ldr r0, [r1]
    bx lr
    .align 2, 0
_0809CE88: .4byte gUnk_08103A18
...
_0809D1C0:
    ...
    ldr r4, [sp, #0x14]
    lsls r6, r4, #2
    ldr r4, _0809D268 @ =gUnk_08103F98
_0809D202:
    ldr r1, [sp, #0x14]
    adds r0, r6, r1
    adds r0, r3, r0
    ...
    cmp r2, r0
    bge _0809D2C4
    ldr r1, _0809D26C @ =gUnk_08103F84
    lsls r0, r3, #2
    adds r0, r0, r1
    ldr r3, [r0]
    mov r2, r8
...
_0809D252:
    ...
    b _0809D272
    .align 2, 0
_0809D268: .4byte gUnk_08103F98
_0809D26C: .4byte gUnk_08103F84
_0809D270:
    adds r2, #1
_0809D272:
    cmp r2, r1
...
_0809D342:
    ...
    adds r3, r4, r3
    add r3, sl
    ldr r1, _0809D368 @ =gUnk_08103FE4
    mov r2, ip
    lsls r0, r2, #2
    adds r0, r0, r1
    ldr r2, [r0]
...
_0809D38C:
    ...
    ldr r1, [sp, #0x14]
    lsls r6, r1, #2
    ldr r1, _0809D414 @ =gUnk_0810400C
    ldr r3, [sp, #0x14]
    adds r0, r6, r3
    lsls r0, r0, #1
    adds r1, r0, r1
...
_0809D558:
    ...
    ldr r1, [sp, #0x14]
    lsls r0, r1, #2
    ldr r1, _0809D5F8 @ =gUnk_08103B38
    ldr r4, [sp, #0x14]
    adds r0, r0, r4
    lsls r0, r0, #1
    adds r1, r0, r1
_0809D5A0:
    ...
    cmp r2, r0
    bge _0809D652
    ldr r1, _0809D5FC @ =gUnk_08103B10
    lsls r0, r3, #2
    adds r0, r0, r1
    ldr r3, [r0]
    lsls r0, r7, #1
...
_0809D5E6:
    ...
    b _0809D602
    .align 2, 0
_0809D5F8: .4byte gUnk_08103B38
_0809D5FC: .4byte gUnk_08103B10
_0809D600:
    adds r2, #1
_0809D602:
    cmp r2, r1
...
_0809D6D2:
    ...
    adds r3, r4, r3
    add r3, sl
    ldr r1, _0809D6F8 @ =gUnk_08103C3C
    lsls r0, r7, #2
    adds r0, r0, r1
    ldr r2, [r0]
    movs r0, #0x3f
...
_0809D71C:
    ...
    ands r2, r0
    movs r7, #0
    ldr r1, _0809D798 @ =gUnk_08103C74
    ldr r3, [sp, #0x14]
    lsls r0, r3, #3
    subs r0, r0, r3
    lsls r0, r0, #1
...
_0809E0E8:
    ldr r0, _0809E0EC @ =gUnk_086DC3C4
    b _0809E112
    .align 2, 0
_0809E0EC: .4byte gUnk_086DC3C4
_0809E0F0:
    ldr r0, _0809E0F4 @ =gUnk_086DC3D0
    b _0809E112
    .align 2, 0
_0809E0F4: .4byte gUnk_086DC3D0
_0809E0F8:
    ldr r0, _0809E0FC @ =gUnk_086DC3DC
    b _0809E112
    .align 2, 0
_0809E0FC: .4byte gUnk_086DC3DC
_0809E100:
    ldr r0, _0809E104 @ =gUnk_086DC3E8
    b _0809E112
    .align 2, 0
_0809E104: .4byte gUnk_086DC3E8
_0809E108:
    ldr r0, _0809E10C @ =gUnk_086DC3F4
    b _0809E112
    .align 2, 0
_0809E10C: .4byte gUnk_086DC3F4
_0809E110:
    movs r0, #0
_0809E112:
    pop {r1}
